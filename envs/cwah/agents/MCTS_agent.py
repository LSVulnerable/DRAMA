...
class MCTS_agent:
    ...
    def get_action(self, obs, goal_spec, opponent_subgoal=None):
        ...
        agent_ids = [node['id'] for node in self.previous_belief_graph['nodes'] if node['class_name'] == 'character']
        goal_spec_dict = {agent_id: goal_spec for agent_id in agent_ids}
        self.sim_env.reset(self.previous_belief_graph, goal_spec_dict)

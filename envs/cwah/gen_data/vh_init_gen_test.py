...
if __name__ == "__main__":
    ...
    for predicates_dict, task_name, pred_str in predicates['test']:
        ...
        for goal_description in demo_goals.keys():
            ...
            if 'ds_' not in goal_description and 'sit_' not in goal_description:
                    ...
                    if success:
                        ...
                        if s:
                            ...
                            for predicate, count in items_list:
                                ...
                                count = min(15 - total_count, count)
                                total_count += count
    ...
    pickle.dump(test_set, open(f'{curr_dir}/../dataset/enhanced_dataset.pik', 'wb'))
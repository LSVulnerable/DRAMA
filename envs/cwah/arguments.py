...
def get_args():
    ...
    # monitor args
    parser.add_argument("--disconnected", action="store_true", help="current agents are disconnected from the environment")
    parser.add_argument("--dis_num", default=1, type=int, help="number of disconnected agents")
    parser.add_argument("--new_join", action="store_true", help="new agents join the environment")
    parser.add_argument("--join_num", default=1, type=int, help="number of new agents joining")

    # test args
    parser.add_argument("--start_task", default=0, type=int, help="test the agents")
    parser.add_argument("--end_task", default=50, type=int, help="test the agents")
